...
template <class T, class E1, class E2, class F> struct BinaryOp {
  ...
  BinaryOp(E1 &left, E2 &right, F func) : left(left), right(right), f(func){};
...
template <typename T, class E1, class E2> struct AddOpCPU {
  T operator()(E1 &left, E2 &right, const std::size_t i, const std::size_t j,
               const std::size_t k) {
...
template <typename T> struct MultOpCPU {
  T operator()(T left, T right, const std::size_t i, const std::size_t j,
               const std::size_t k) {
...
BinaryOp<T, E1, E2, AddOpCPU<T, E1, E2>> add(E1 &left, E2 &right) {
  ...
  return BinaryOp<T, E1, E2, AddOpCPU<T, E1, E2>>(left, right,
                                                  AddOpCPU<T, E1, E2>());
}
